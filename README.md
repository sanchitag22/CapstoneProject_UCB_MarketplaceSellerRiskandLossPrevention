...
**Findings:** The best-performing model is a **Random Forest classifier**, correctly identifying roughly 68% of genuinely high-risk sellers in a held-out test set, with an ROC-AUC of 0.81 (a common measure of how well a model ranks risky sellers above safe ones, where 0.5 is random guessing and 1.0 is perfect). This is a meaningful improvement over an earlier, simpler baseline model, which caught only 61% of high-risk sellers.
